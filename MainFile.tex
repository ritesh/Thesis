...
\begin{abstract}
Image steganography provides an alternative means of communication between parties
...
tries to identify images that contain steganographic content from a random selection of images obtained from free classified advertisements.
\end{abstract}
